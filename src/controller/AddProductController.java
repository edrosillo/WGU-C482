...
/**
 * The AddProductController class provides control logic for the add product screen of the application.
 */
...
public class AddProductController implements Initializable {
    ...
    /**
     * Initializes the AddProductController, populates table views for the Parts table and the Associated Parts
     * and sets up the variable to be used for the Unique ID generation..
